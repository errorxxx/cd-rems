                        ...
                        var $dd = $this.find('dd').each(function () {
                            if( $(this).next('ul').length >0){
                                $(this).on('click', function () {
                                    ...
                                    $($(this).find('span>i')[0]).toggleClass("fa-chevron-right fa-chevron-up");
                                });
                            }else{
                                $(this).on('click', function () {
            ...
            if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
                ...
                if (data[i].icon !== undefined && data[i].icon !== '') {
                    if (data[i].icon.indexOf('fa-') !== -1) {
                        ulHtml += '<i class="fa ' + data[i].icon + '" aria-hidden="true" data-icon="' + data[i].icon + '" style="font-size: 16px;"></i>';
                    } else {
                    ...
                    if(data[i].children[j].children !== undefined && data[i].children[j].children !== null && data[i].children[j].children.length > 0){
                        ...
                        if (data[i].children[j].icon !== undefined && data[i].children[j].icon !== '') {
                            if (data[i].children[j].icon.indexOf('fa-') !== -1) {
                                ulHtml += '<i class="fa ' + data[i].children[j].icon + '" data-icon="' + data[i].children[j].icon + '" aria-hidden="true" style="font-size: 16px;"></i>';
                            } else {
                                ulHtml += '<i class="layui-icon" data-icon="' + data[i].children[j].icon + '">' + data[i].children[j].icon + '</i>';
                            }
                        }
                        ulHtml += '<cite>' + data[i].children[j].title + '</cite>';
                        ulHtml += '<span class="layui-nav-more-more "><i class="fa fa-chevron-right"></i></span>';
                        ulHtml += '</a>';
                        ulHtml += '</dd>';

                        ulHtml +='<ul class="layui-nav-child-child" style="display: none;">';
                        for(var k = 0; k<data[i].children[j].children.length; k++){
                            ulHtml += '<li title="' + data[i].children[j].children[k].title + '">';
                            ...
                            if (data[i].children[j].children[k].icon !== undefined && data[i].children[j].children[k].icon !== '') {
                                if (data[i].children[j].icon.indexOf('fa-') !== -1) {
                                    ulHtml += '<i class="fa ' + data[i].children[j].children[k].icon + '" data-icon="' + data[i].children[j].children[k].icon + '" aria-hidden="true" style="font-size: 16px;"></i>';
                                } else {
