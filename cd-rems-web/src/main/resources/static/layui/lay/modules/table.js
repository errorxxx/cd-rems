        ...
        A.prototype.config = {
                ...
                if (n.url) {
                    ...
                    c[o.pageName] = e,
                        ...
                        t.ajax({
                            ...
                            dataType: "json",
                            success: function(t) {
                                return t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, t[r.countName]), d(), i && l.close(i), void("function" == typeof n.done && n.done(t, e, t[r.countName])))
                            },
                            error: function(e, t) {
            ...
            A.prototype.renderData = function(e, n, o, r) {
                                ...
                                0 !== a.length && (r || (a[d.config.indexName] = e), c.eachCols(function(e, n) {
                                    ...
                                    if (void 0 !== h && null !== h || (h = ""), !(n.colspan > 1)) {
                                        ...
                                        function() {
                                            var e = [];
                                            if(n.styles){
                                                for(var i=0;i<n.styles.length;i++){
                                                    var flag = false;
                                                    if(n.styles[i].condition=='!='){
                                                        if(a[n.styles[i].field]!=n.styles[i].value){
                                                            flag = true;
                                                        }
                                                    }else{
                                                        if(a[n.styles[i].field]==n.styles[i].value){
                                                    ...
                                                    if(flag){
                                                        n.style=n.style==undefined?'':n.style;
                                                        n.style+=n.styles[i].style
                                                    }
                                                }
                                            }
                ...
                return c.key = s.id || s.index,
                    d.cache[c.key] = u,
                    r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">无数据</div>')) : (m(), void(s.page && (c.page = n, c.count = o, s.page = t.extend({
            ...
            A.prototype.renderForm = function(e) {
                ...
                if(this.config.selectAll!=undefined && !this.config.selectAll){//取消全选功能
                    this.layHeader.find("th .layui-icon").hide();
                }
            },
            ...
            A.prototype.scrollPatch = function() {
                ...
                if (n && !e.scrollPatchWStatus) {
                    var o = e.layHeader.eq(0).find("thead th:last-child"),
                        r = o.data("field");
                    e.getCssRule(r,
                        function(t) {
                            var i = t.style.width || o.outerWidth();
                            t.style.width = parseFloat(i) - n + "px",
                ...
                if (a && l) {
                    if (!e.elem.find(".layui-table-patch")[0]) {
                        ...
                        d.find("div").css({
                            ...
                            e.layHeader.eq(0).find("thead tr").append(d)
                    }
                } else e.layHeader.eq(0).find(".layui-table-patch").remove();
                var c = e.layMain.height(),
                    s = c - l;
                e.layFixed.find(m).css("height", i.height() > s ? s: "auto"),
                    e.layFixRight[i.width() > e.layMain.width() ? "removeClass": "addClass"](h),
                ...
                u.on("mousemove",
                    ...
                    a.elem.on("click", 'input[name="layTableCheckbox"]+',
                        function() {
                            ...
                            o ? (!a.config.singleSelect?(i.each(function (e, t) {
                                t.checked = n, a.setCheckData(e, n)
                            }), a.syncCheckAll(), a.renderForm()):null) : (
                                a.config.singleSelect?(i.each(function (e, t) {
                                    e!=l?(t.checked = false, a.setCheckData(e, false)):null}),
                                    a.renderForm("checkbox")):null,a.setCheckData(l, n),a.syncCheckAll()
                            ), layui.event.call(this, s, "checkbox(" + f + ")", {
                                checked: n,
                                data: d.cache[a.key][l],
                                type: !a.config.singleSelect&&o ? "all" : "one"
                            })
